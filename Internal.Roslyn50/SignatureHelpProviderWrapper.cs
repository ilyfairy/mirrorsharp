...
internal class SignatureHelpProviderWrapper : ISignatureHelpProviderWrapper {
    ...
    public bool IsRetriggerCharacter(char ch) => _provider.TriggerCharacters.Contains(ch);
    public bool IsTriggerCharacter(char ch) => _provider.TriggerCharacters.Contains(ch);
}
